...
const geminiChecks = [
  ...
  {
    label: 'Endpoint do Google Gemini configurado (gemini-1.5-flash)',
    test: chatJsContent.includes('models/gemini-1.5-flash:generateContent') && serverJsContent.includes('models/gemini-1.5-flash:generateContent')
  },
  {
